...
const options = [
    ...
    { id: 'Education & Training Videos', label: 'Education & Training Videos', emoji: '🎓' },
    { id: 'Product Demos', label: 'Product Demos', emoji: '🛍️' },
    { id: 'Internal Communications', label: 'Internal Communications', emoji: '🏢' },
...
export default function OnboardingStep1() {
    ...
    function handleContinue() {
        if (!selected) return
        localStorage.setItem('contentType', selected)
